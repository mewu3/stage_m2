...
### load input files
datadir <- "/datater/wu/data/MSSPE-variant/enterovirus/kmer15/evaluation"
# datadir <- "/datater/wu/data/MSSPE-variant/zika/kmer13/evaluation"
# datadir <- "/datater/wu/data/MSSPE-variant/coronavirus/kmer13/evaluation"
