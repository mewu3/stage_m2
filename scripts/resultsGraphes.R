...
###################################
commande <- sprintf("grep -c '^>' %s", "/home/meijun/Documents/server/data/MSSPE-variant/coronavirusCurated/coronavirusCurated.msa")
seqCount = system(commande, intern=TRUE)


seqCount = as.numeric(seqCount)
workdir <- "/home/meijun/Documents/server/data/MSSPE-variant/coronavirusCurated/kmer13/evaluation"
