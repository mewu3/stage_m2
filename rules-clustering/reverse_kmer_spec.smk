rule specific1:
    ...
    output:
        f"{dataDir}/{{sample}}{clustering_identity}/kmer{kmerSize}/intermediate/allKmerCount.sorted.calculated.filtered.fasta"
    run:
        import os
...
rule specific3:
    input:
        f"{dataDir}/{{sample}}{clustering_identity}/kmer{kmerSize}/intermediate/allKmerCount.sorted.calculated.filtered.fasta"
    output:
        f"{dataDir}/{{sample}}{clustering_identity}/kmer{kmerSize}/intermediate/allKmerCount.sorted.calculated.filtered.bowtie"
    params:
...
rule specific4:
    input:
        ...
        f"{dataDir}/{{sample}}{clustering_identity}/kmer{kmerSize}/allKmerCount.sorted.calculated.filtered.txt"
    output:
        f"{dataDir}/{{sample}}{clustering_identity}/kmer{kmerSize}/allKmerCount.sorted.calculated.filtered.spec.txt"
    params:
