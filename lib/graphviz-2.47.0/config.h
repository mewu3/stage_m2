...
/* Define to 1 if you have the `cairo_surface_set_mime_data' function. */
#define HAVE_CAIRO_SURFACE_SET_MIME_DATA 1
...
/* Define to 1 if you have the <sys/vfork.h> header file. */
...
#define PACKAGE_STRING "graphviz 2.47.0"
